...
btnpi = Button(calc, text="π", width=6, height= 2, font=('arial', 20, 'bold'), bd=4, bg="#B6D0E2", command= added_value.pi).grid(row=1, column=4, pady=1)
...
btn2Pi = Button(calc, text="2π", width=6, height= 2, font=('arial', 20, 'bold'), bd=4, bg="#B6D0E2", command= added_value.tau).grid(row=2, column=4, pady=1) 
