...
#Heading
Label(root, text="Welcome to Sam Travels", font="comicsansms 13 bold", pady=15).grid(row=0, column=3)
...
Button(text="Submit to Sam Travels", command=getvals).grid(row=7, column=3)
